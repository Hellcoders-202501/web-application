			...
			<Popover>
				...
				>
					<div className="flex flex-col gap-5 p-5">
						<NotificationCard type="accepted" userType={userType} />
						<NotificationCard type="declined" userType={userType} />
						<NotificationCard type="offer" userType={userType} />
						<NotificationCard type="completed" userType={userType} />
						<NotificationCard type="finalized" userType={userType} />
					</div>
				</PopoverPanel>
			</Popover>
		</div>
