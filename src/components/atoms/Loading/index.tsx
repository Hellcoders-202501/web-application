...
const Loading = (props: Props) => {
  return (
    <div
      className={`flex h-full justify-center items-center text-2xl text-tc-blue-300 font-semibold ${props.containerClass}`}
    >
      <div className="animate-spin w-24 h-24 rounded-xl flex items-center justify-center">
